...
Problem.Mesh.boundingBox = {-0.001, -0.001, 0.0055, 0.06} -- Maybe a changer; jsp trop ce que doit contenit la bounding bow en axisym 
...
Problem.Extractors[2].outputFile = 'pAxisym.txt'
