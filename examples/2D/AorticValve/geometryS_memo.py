...
x1=-f
y1=-Z
p.append(sh.occ.addPoint(x1,y1,0,d2)) # 1
...
p.append(sh.occ.addPoint(-x2,y2,0,d2)) # 6
p.append(sh.occ.addPoint(-x1,y1,0,d2)) # 7

p.append(sh.occ.addPoint(-x1,y1-t1,0,d2)) # 8

x9=math.sqrt((R+t1)**2-(Z+t1)**2)
y9=-(Z+t1)
p.append(sh.occ.addPoint(x9,y9,0,d2)) # 9
p.append(sh.occ.addPoint(-x9,y9,0,d)) # 10
p.append(sh.occ.addPoint(x1,y9,0,d2)) # 11
...
p.append(sh.occ.addPoint(x1,-y1,0,d2)) # 13
...
p.append(sh.occ.addPoint(-x2,-y2,0,d2)) # 18
p.append(sh.occ.addPoint(-x1,-y1,0,d2)) # 19
p.append(sh.occ.addPoint(-x1,-y1+t1,0,d2)) # 20
p.append(sh.occ.addPoint(x9,-y9,0,d2)) # 21
p.append(sh.occ.addPoint(-x9,-y9,0,d)) # 22
p.append(sh.occ.addPoint(x1,-y1+t1,0,d2)) # 23
...
sh.addPhysicalGroup(1,l[1:4] +h[7:10] , name='FSInterface')
...
sh.addPhysicalGroup(1,l[0:1] + l[4:12] + h[0:7] + h[10:12],name='Sides')
