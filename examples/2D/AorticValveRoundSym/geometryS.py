...
p.append(sh.occ.addPoint(-x1,0,0)) # 27
p.append(sh.occ.addPoint(x1,0,0)) # 28
...
h2.append(sh.occ.addLine(p[27],p[28])) 
...
sh.addPhysicalGroup(1,l2[0:3],name='FSInterface')

sh.addPhysicalGroup(1,l2[1:3],name='LeafletBottom')
#sh.addPhysicalGroup(1,h2[0:2],name='LeafletUp')


sh.addPhysicalGroup(1,l2[3:4],name='Sides')

sh.addPhysicalGroup(1,h2[0:1],name='Axis')
