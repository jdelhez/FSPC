...
def getMetafor(parm):
    ...
    materset.define(3,w.StickingContactMaterial)
    materset(3).put(w.PEN_TANGENT,4*penalty)
    materset(3).put(w.PEN_NORMALE,5*penalty)
    materset(3).put(w.PROF_CONT,0.0005)      # 0.0005
