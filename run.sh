...
# export SCRIPT=${PWD}/examples/2D/waterJet_break/main.py
# export SCRIPT=${PWD}/examples/2D/waterJet_break_2/main.py
export SCRIPT=${PWD}/examples/2D/hydroStatic_break/main.py
