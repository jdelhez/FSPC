...
sh.addPhysicalGroup(2,s[0:2],name='Solid')

sh.addPhysicalGroup(1,l2[0:4],name='Leafet_Bot')
sh.addPhysicalGroup(1,h2[0:4],name='Leafet_Top')

sh.addPhysicalGroup(1,l2[1:3],name='Contact_Bot')
sh.addPhysicalGroup(1,h2[0:2],name='Contact_Top')
