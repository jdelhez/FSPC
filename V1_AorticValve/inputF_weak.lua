...
Problem.Material.K0 = 220000
Problem.Material.K0p = 7.6
Problem.Material.rhoStar = 1060
...
function Problem.Solver.MomEq.BC.BoundaryV(x, y, z, t)
    return 0, 0
end

function Problem.Solver.MomEq.BC.InletP(x, y, z, t)
    T = 0.85;
    omega = 2*math.pi/T
    tf = t + 0.01
    tf = t 
