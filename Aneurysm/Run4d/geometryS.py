...
p.append(sh.occ.addPoint(r,-L1-LR,0)) # 0
p.append(sh.occ.addPoint(r+e,-L1-LR,0)) # 1 
p.append(sh.occ.addPoint(r+e,-LR,0)) #2
p.append(sh.occ.addPoint(r,-LR,0)) #3




p.append(sh.occ.addPoint(r,LR,0)) #4
p.append(sh.occ.addPoint(r+e,LR,0)) #5
p.append(sh.occ.addPoint(r+e,+L2+LR,0)) #6 
p.append(sh.occ.addPoint(r,+L2+LR,0)) #7
...
sh.mesh.setTransfiniteCurve(l1[0],Nx)
sh.mesh.setTransfiniteCurve(l1[1],N1y)
sh.mesh.setTransfiniteCurve(l1[2],Nx)
...
sh.addPhysicalGroup(1, l1[3:4]+l2[3:4]+l3[3:4] , name='FSInterface')
