...
p.append(sh.occ.addPoint(r+e,-L1/2-6*r,0)) #46
p.append(sh.occ.addPoint(r,-L1/2-6*r,0)) #47
p.append(sh.occ.addPoint(r,+L2/2+6*r,0)) #48
p.append(sh.occ.addPoint(r+e,+L2/2+6*r,0)) #49

# Lines List

l1 = list()
l1.append(sh.occ.addLine(p[0],p[1])) 
l1.append(sh.occ.addLine(p[1],p[46])) 
l1.append(sh.occ.addLine(p[46],p[47])) 
l1.append(sh.occ.addLine(p[47],p[0])) 

l2 = list()

l2.append(sh.occ.addLine(p[47],p[46])) 
...
l2.append(sh.occ.addLine(p[49],p[48]))
lp=list()
lp.append(p[48])
lp.append(p[4])
...
l3 = list()
l3.append(sh.occ.addLine(p[48],p[49])) 
l3.append(sh.occ.addLine(p[49],p[6])) 
l3.append(sh.occ.addLine(p[6],p[7])) 
l3.append(sh.occ.addLine(p[7],p[48])) 
...
sh.addPhysicalGroup(1,l3[3:4] + l2[3:4] + l1[3:4], name='FSInterface')
sh.addPhysicalGroup(1,l1[0:2] + l3[1:3],name='Sides')
